<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入教师姓名查询" style="width: 200px" v-model="teacher"></el-input>
      <el-input placeholder="请输入评教内容查询" style="width: 200px;margin-left: 5px" v-model="content"></el-input>
